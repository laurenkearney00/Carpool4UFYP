...
public class ViewPassengers extends FragmentActivity implements OnMapReadyCallback {
...
// Add a marker in Sydney and move the camera
    ...
    public void getLocation() {
        if (ActivityCompat.checkSelfPermission(getApplicationContext(),
            ...
            ActivityCompat.requestPermissions(ViewPassengers.this,
    ...
    public void location() {
        ...
        DatabaseReference currentDBcordinates = FirebaseDatabase.getInstance().getReference().child("PassengerLocations");
    ...
    public void marker() {
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(@NonNull Marker marker) {
                 ...
                 */
                Intent i = new Intent(ViewPassengers.this, MessagePassenger.class);
