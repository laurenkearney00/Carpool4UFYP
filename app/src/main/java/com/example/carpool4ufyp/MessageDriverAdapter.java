...
public class MessageDriverAdapter extends RecyclerView.Adapter<MessageDriverAdapter.MyViewHolder> {
    ...
    public MessageDriverAdapter(MessageDriver messageDriver, ArrayList<Message> messages) {
        list = messages;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public MessageDriverAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
