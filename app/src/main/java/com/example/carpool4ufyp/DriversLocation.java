...
public class DriversLocation extends AppCompatActivity {
...
//added userid to current location
    ...
    public void getLocation() {
        if (ActivityCompat.checkSelfPermission(getApplicationContext(),
            ...
            ActivityCompat.requestPermissions(DriversLocation.this,
    ...
    public void saveCurrentLocation(LatLng latlng) {
        ...
        FirebaseDatabase.getInstance().getReference().child("DriverLocations")
                .push()
