...
import java.util.ArrayList;
    public class MessagePassengerAdapter extends RecyclerView.Adapter<MessagePassengerAdapter.MyViewHolder> {
        ...
        public MessagePassengerAdapter(MessagePassenger viewMessages, ArrayList<Message> messages) {
            list = messages;
        }

        // Create new views (invoked by the layout manager)
        @Override
        public MessagePassengerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            // create a new view
        ...
        @Override
        public void onBindViewHolder(MessagePassengerAdapter.MyViewHolder holder, int position) {
